...
# prepare the figure
# NEED TO PUT THE TEST IN A BETTER ORDER AND RENAME ROWS AND COLUMNS
fig_factanal <-
  ...
  lapply(
    ...
    scale_fill_manual( values = c("grey89","#E69F00") ) +
    labs( x = "Factor loading", y= NULL ) +
    #geom_vline( xintercept = 0, linewidth = .75, linetype = "dashed", color = "black" ) +
    facet_wrap( ~ factor( factor, levels = colnames( loadings(fa$efa[[1]][[5]]) ) ), nrow = 1 ) +
