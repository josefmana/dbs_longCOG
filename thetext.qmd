...
conflicted::conflict_prefer_all("brms")
conflicted::conflict_prefer_all("ggridges")
...
fig_ce <-
  ...
  lapply(
    ...
    function(i)
      ...
      facet_wrap( ~case_when( i == "RQ1" ~ "Description model", i == "RQ2" ~ "Direct effect model" ) ) +
      theme( legend.position = "none" )
